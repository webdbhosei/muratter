...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post chatrooms_url, params: { chatroom: { manager_id: @chatroom.manager_id, name: @chatroom.name, parent_id: @chatroom.parent_id } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { manager_id: @chatroom.manager_id, name: @chatroom.name, parent_id: @chatroom.parent_id } }
